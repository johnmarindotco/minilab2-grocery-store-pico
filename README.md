...
The scope of this project is to create a "grocery store system" that iterates over common grocery items.

Items are stored and shuffled through using buttons.

An LCD screen displays item information along with red and green light bulbs that light up once a button is pressed.

A buzzer sound is also activated for every button push.
